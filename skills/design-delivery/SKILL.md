...
description: >
  Use when running any stage of the design delivery process for a page package: the brief and design space, generating or evaluating alternatives, the assumption audit, requirement coverage verification, visual refinement, the freeze, the page specification and acceptance criteria, and the S10 gate.
---

<!-- Generated by tools/build_skills.py from `governance/90-design-delivery.md`. Edit the sources, not this file. -->
