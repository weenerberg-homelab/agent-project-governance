---
name: project-structure-tiers
description: >
  Use when creating a project, assigning or changing its governance tier, or checking which files, tests, CI and documentation a tier requires.
---

<!-- Generated by tools/build_skills.py from `project_patterns/10-project-structure-tiers.md`. Edit the sources, not this file. -->
