...
description: >
  Use when writing or checking a work item, instruction, report, review, decision or milestone document, or a prompt or report between roles: required header fields, vocabularies, the Blocked on shape, the execution envelope, the header and footer, and the handoff block.
---
