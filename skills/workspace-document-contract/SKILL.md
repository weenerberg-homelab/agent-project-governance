---
name: workspace-document-contract
description: >
  Use when writing or checking a work item, instruction, report, review, decision or milestone document, or a prompt or report between roles: required header fields, vocabularies, the Blocked on shape, the execution envelope, the header and footer, the handoff block, and where each field lives on a board-backed project.
---

<!-- Generated by tools/build_skills.py from `governance/60-workspace-document-contract.md`. Edit the sources, not this file. -->
