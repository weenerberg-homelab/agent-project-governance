...
description: >
  Use when dispositioning findings, compiling or posting a board card, checking or approving a release summary, writing a review with findings, answering review findings in a rework report, or accepting a technical or product milestone.
---

<!-- Generated by tools/build_skills.py from `governance/70-review-and-release.md` (Dispositions of findings), `governance/70-review-and-release.md` (Board cards), `governance/70-review-and-release.md` (Release), `governance/70-review-and-release.md` (Reviews, rework and acceptance). Edit the sources, not this file. -->
